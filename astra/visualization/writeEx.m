function [outputArg1,outputArg2] = writeEx(type_in, psize_in, nr_in, met_in, org_in, file)
% Astra visualization
...
case_nr = ["DLDP_081", "DLDP_082", "DLDP_088", "DLDP_090"];
...
colormapBrew = load(fullfile(repo_root, "colormapBrew.mat"));
colormapRedBrew = load(fullfile(repo_root, "colormapRedBrew.mat"));
colormapRedBrew = load(fullfile(repo_root, "colormapRedBrew.mat"));
...
if(met == 1)
    if((org == 2) ||(org == 5) || (org == 6) || (org == 7) || (org == 8) || (org == 9))
        ...
        elseif ((max_allowedVal > min_val) && (max_allowedVal < max_val))
            ...
            c = colorbar('Ticks',[min_scaled 1 max_scaled],...
...
% if(met == 1)
%     if((org == 2) ||(org == 5) || (org == 6) || (org == 7) || (org == 8) || (org == 9))
%         colormp = heatmapConfigT.objectConfig.Colormap;
